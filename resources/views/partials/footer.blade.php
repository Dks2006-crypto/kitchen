<footer class="bg-gray-800 text-white pt-12 pb-8 mt-6">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        <div class="col-span-1">
          <div class="flex items-center mb-4">
            <span class="ml-2 text-xl font-bold">Coocks</span>
          </div>
          <p class="text-gray-400 text-sm">
            Компания, которая делает вашу жизнь лучше с 2010 года. Качество и надежность - наш приоритет.
          </p>
        </div>
        ...
        <div>
          ...
          <div class="flex space-x-4">
            ...
            <a href="#" class="bg-gray-700 hover:bg-pink-600 h-10 w-10 rounded-full flex items-center justify-center transition">
            ...
            <a href="#" class="bg-gray-700 hover:bg-blue-400 h-10 w-10 rounded-full flex items-center justify-center transition">
      ...
      <div class="md:hidden space-y-4 mb-6">
        <div x-data="{ open: false }">
          ...
          <div x-show="open" x-collapse class="mt-2 pl-4 space-y-2">
            <a href="#" class="block text-gray-400 hover:text-white">Главная</a>
            <a href="#" class="block text-gray-400 hover:text-white">О нас</a>
            <a href="#" class="block text-gray-400 hover:text-white">Услуги</a>
            <a href="#" class="block text-gray-400 hover:text-white">Блог</a>
          </div>
        </div>
        ...
        <div x-data="{ open: false }">
          ...
          <div x-show="open" x-collapse class="mt-2 pl-4 space-y-2 text-gray-400">
            <div class="flex items-start">
              <svg class="h-5 w-5 mr-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
              </svg>
              г. Волгоград, ул. Примерная, 123
            </div>
      ...
      <div class="border-t border-gray-700 pt-6 mt-6 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm mb-4 md:mb-0">
          © 2023 Coocks. Все права защищены.
        </p>
